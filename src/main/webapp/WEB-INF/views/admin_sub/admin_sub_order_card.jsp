...
<div class="container">
    <table class="table table-bordered" style="border: 2px solid #000000; text-align: center;">
      ...
      <div><p style="font-weight:bold; font-size:30px;'">카드 취소 관리</p></div> 
    ...
    <br>
        ...
        <table class="table table-bordered" style="border: 2px solid #000000; text-align: center;">
          <tbody>
            <tr>
                <td colspan="12"><select class="option-name" style="margin-right:5px; float:right;">
                  <option value="productname">결제일순</option>
                  <option value="productname">결제일역순</option>
                  <option value="productname">취소일순</option>
                  <option value="productname">취소일 역순</option>
                </select>
            ...
            <tr>
              ...
              <td class="table-light">결제일(취소일)</td>
              <td class="table-light"> 주문번호</td>
              <td class="table-light">주문자</td>
              <td class="table-light">TID(거래번호)</td>
              <td class="table-light">취소금액</td>
              <td class="table-light">취소구분</td>
              <td class="table-light">취소처리자</td>
            </tr>
