...
<div class="container">
    <table class="table table-bordered" style="border: 2px solid #000000; text-align: center;">
      ...
      <div><p style="font-weight:bold; font-size:30px;'">취소 관리</p></div> 
        ...
        <tr>
          ...
          <td>
            <select class="option-name" style="margin-right:5px">
              ...
              <option value="productname">취소신청일</option>
              <option value="productname">취소접수일</option>
              <option value="productname">취소완료일</option>
            </select>
    ...
    <br>
        ...
        <table class="table table-bordered" style="border: 2px solid #000000; text-align: center;">
          <tbody>
            <tr>
                <td colspan="10"><select class="option-name" style="margin-right:5px; float:right;">
                  <option value="productname">주문일순</option>
                  <option value="productname">주문일 역순</option>
                  <option value="productname">취소접수일순</option>
                  <option value="productname">취소접수일 역순</option>
                  <option value="productname">취소신청일순</option>
                  <option value="productname">취소신청일 역순</option>
                </select>
            ...
            <tr>
              ...
              <td class="table-light">취소 신청일<p>(취소 접수일)</p></td>
              <td class="table-light" >품목별<p style=font-size:10px;>주문번호/취소번호</p></td>
