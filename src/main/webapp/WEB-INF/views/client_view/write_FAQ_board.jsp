...
<form action="write_FAQ_board.do" method="post">
    ...
    <div class="row d-flex" style="flex-wrap: nowrap;">
      ...
      <div style="margin:3px 0px;">
        <input class="input" name="faq_board_subject" style="border-radius:0; border: black solid 1px; width:100%; padding:10px; margin:10px 0px;" placeholder="제목">
      </div>
  <div style="margin:3px 0px;">
 
   <textarea name="faq_board_content" id="editor" placeholder="게시글을 작성하세요.">
    </textarea>
    <script>
        ClassicEditor
