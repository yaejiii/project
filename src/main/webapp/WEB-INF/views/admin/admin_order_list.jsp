...
<tr>
	<form name="f" action="admin_order_search.do" method="post">							
		<div class="row">
			<div class="col" align="center" style="padding: 10px 10px">
				...
				<input type="text" name="searchString" placeholder="검색할 내용을 입력하세요...">
</tr>
<tr>
<!-- 	<div class="ui-grid-b">
    <div class="ui-block-c">
        ...
        <div>
           <input type="button" onclick="check()" value="검색" class="btn btn-dark">
      ...
      <div class="row">
        ...
        <div class="col-12">
          <table class="table">
            <thead>
            <th><a href  ="admin_order_list.do">전체목록으로</a></th>
              <tr>
            ...
            <tbody>
              <tr>
                ...
                <td colspan = "8" align = "center">주문 목록이 존재하지 않습니다.</td>
               ...
               <td>                              		                            
                ...
                <td><a href ="admin_order_view.do?order_history_num=${dto.order_history_num}">${dto.order_history_num}</a></td>
...
<c:if test="${count >0}">
			...
			<c:if test="${mode != 'Y'}">
				<c:if test="${startPage > pageBlock}">
					[<a href="admin_order_list.do?pageNum=${startPage - 1}">이전</a>]	
				</c:if>
				<c:forEach var="i" begin="${startPage}" end="${endPage}">
					[<a href="admin_order_list.do?pageNum=${i}">${i}</a>]		
				</c:forEach>
				<c:if test="${endPage < pageCount}">
					[<a href="admin_order_list.do?pageNum=${endPage+1}">다음</a>]
				</c:if>
			</c:if>	
</c:if>
